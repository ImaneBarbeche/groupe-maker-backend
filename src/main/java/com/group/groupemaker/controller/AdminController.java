...
import com.group.groupemaker.repository.PartagesListeRepository;
...
public class AdminController {
    ...
    private final PartagesListeRepository partagesListeRepository;

    public AdminController(UtilisateurRepository utilisateurRepository, 
                          ListeRepository listeRepository,
                          HistoriqueRepository historiqueRepository, 
                          PartagesListeRepository partagesListeRepository) {
        this.utilisateurRepository = utilisateurRepository;
        this.listeRepository = listeRepository;
        this.historiqueRepository = historiqueRepository;
        this.partagesListeRepository = partagesListeRepository;
    }
    ...
    public ResponseEntity<Map<String, Object>> getStatistiques() {
        ...
        long totalPartages = partagesListeRepository.count();
        stats.put("totalPartages", totalPartages);
        ...
        if (totalListes > 0) {
            ...
            stats.put("moyennePartagesParListe", (double) totalPartages / totalListes);
        } else {
            stats.put("moyenneTiragesParListe", 0.0);
            stats.put("moyennePartagesParListe", 0.0);
        }
